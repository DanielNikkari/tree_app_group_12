      ...
      <nav className="navbar fixed-bottom navbar-light bg-light">
        ...
        <li className="nav-item m-3 me-lg-0">
          { pathname === "/" ?
            ...
            :
            <a href="/" className="navbar-brand" ><i className="fa fa-home" style={{color: 'black'}}></i></a>
          }
        </li>
        <li className="nav-item m-3 me-lg-0">
        { pathname === "/treeregister" ?
          ...
          :
          <a href="/treeregister" className="navbar-brand" ><i className="fa fa-plus" style={{color: 'black'}}></i></a>
        }
        </li>
        <li className="nav-item m-3 me-lg-0">
        { pathname === "/treelist" ?
          ...
          :
          <a href="/treelist" className="navbar-brand" ><i className="fa fa-list" style={{color: 'black'}}></i></a>
        }
        </li>
        <li className="nav-item m-3 me-lg-0">
        { pathname === "/profile" ?
          ...
          :
          <a href="/" className="navbar-brand" ><i className="fa fa-user" style={{color: 'black'}}></i></a>
        }
        </li>
        </ul>
      </nav>
